# Generated by Django 5.1.6 on 2025-07-08 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('ai', 'Artificial Intelligence'), ('ml', 'Machine Learning'), ('cs', 'Computer Science'), ('bio', 'Biology'), ('physics', 'Physics'), ('chemistry', 'Chemistry'), ('math', 'Mathematics'), ('engineering', 'Engineering'), ('medicine', 'Medicine'), ('psychology', 'Psychology')], max_length=100)),
